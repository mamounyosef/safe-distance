# Lost and Found obstacle benchmark: `yoloe-11s-seg_prompts-v1`
...
| Vocabulary | open vocabulary, 14 prompts: `car`, `van`, `truck`, `bus`, `motorcycle`, `bicycle`, `person`, `traffic cone`, `construction barrier`, `traffic barricade`, `animal`, `obstacle`, `box`, `bucket` |
| Input size | 1280 |
...
| Created (UTC) | 2026-09-22T20:03:35+00:00 |
...
| --- | --- | --- | --- | --- |
| 0-10 m | 88 | 94% | 90% | 66% |
| 10-20 m | 265 | 82% | 67% | 43% |
| 20-30 m | 247 | 51% | 32% | 19% |
| 30-50 m | 584 | 26% | 18% | 12% |
| 50+ m | 540 | 22% | 16% | 9% |
...
| --- | --- | --- | --- | --- |
| random hazards | 563 | 35% | 25% | 13% |
| standard objects | 535 | 27% | 14% | 5% |
| emotional hazards | 423 | 43% | 34% | 25% |
| humans | 203 | 86% | 81% | 66% |
