# KITTI road-user benchmark: `yoloe-11s-seg_prompts-v3`
...
| Class conversion | car and van -> Car; person and pedestrian -> Pedestrian; cyclist -> Cyclist; bicycle merged with its rider (person box >= 30% inside the bicycle box) -> Cyclist; rider-less bicycles dropped (parked bikes are unlabelled in KITTI) |
| Hardware | NVIDIA GeForce RTX 4060, FP16 |
| Software | Python 3.12.0, torch 2.6.0+cu124, ultralytics 8.4.155 |
| Git commit | `a0e55b3` (with uncommitted changes) |
| Created (UTC) | 2026-09-23T12:10:02+00:00 |
...
| Pedestrian | 65.7% | 52.5% | 44.6% | 416 | 648 | 785 |
| Cyclist | 20.4% | 15.9% | 16.2% | 125 | 219 | 238 |
...
| --- | --- | --- | --- | --- |
| car | 5946 | 80% | 70% | 48% |
| pedestrian | 869 | 61% | 48% | 19% |
| van | 548 | 77% | 69% | 49% |
| cyclist | 324 | 58% | 46% | 22% |
| truck | 235 | 82% | 75% | 59% |
| tram | 127 | 51% | 47% | 32% |
...
| --- | --- | --- | --- | --- | --- | --- |
| 0-10 m | 91% (n=657) | 82% (n=246) | 94% (n=34) | 79% (n=24) | 81% (n=16) | 80% (n=5) |
| 10-20 m | 89% (n=1382) | 66% (n=335) | 92% (n=103) | 75% (n=89) | 77% (n=13) | 91% (n=11) |
| 20-30 m | 80% (n=1367) | 50% (n=153) | 84% (n=116) | 52% (n=88) | 77% (n=35) | 25% (n=36) |
| 30-50 m | 75% (n=1841) | 25% (n=110) | 73% (n=150) | 55% (n=104) | 84% (n=73) | 32% (n=37) |
